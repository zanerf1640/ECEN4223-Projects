...
def generate_launch_description():
    ...
    # SLAM params
    default_slam_params = 'config/rosmaster_x3_nav2_default_params.yaml'
    ...
    slam_params_default_path = os.path.join(pkg_share_navigation, default_slam_params)
    ...
    declare_slam_params_cmd = DeclareLaunchArgument(
        ...
        default_value=slam_params_default_path,
    ...
    # Start core ROS publishing TF/robot_description
    ...
    # Delay controllers a bit so controller_manager exists
    ld.add_action(TimerAction(period=3.0, actions=[load_controllers_cmd]))
    
    # Delay SLAM so TF + /scan are stable
